...
try:
	...
	for j in range(len(lista)): #recorremos la lista para saber  los numeros con menos de 3 digitos

		
		if lista[j] < 100: #condicionamos para saber quienes tienen menor digito

			menores.append(lista[j]) #los que cumplan la condicion agregamos la posicion a la lista
			cont += 1
