...
try:
	...
	for i in range(10): #obtenemos los numeros 
		...
		numeros.append(num) #agregamos los numeros a la lista

	for j in range(len(numeros)): #recorremos la lista para saber las posciones de los numeros con mas de 3 digitos

		
		if numeros[j] > 99: #condicionamos para saber quienes tienen mayor digito
