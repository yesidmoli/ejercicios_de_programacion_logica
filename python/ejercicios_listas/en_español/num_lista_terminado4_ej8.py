...
try: #creamos las lista vacias 
	...
	for j in range(len(numeros)): #creamos un ciclo para recorrer lo que hya en lista y determinar cuales numeros terminan en 4


		if numeros[j] % 10 == 4: #condicionamos modulando lo que hay en j para obtener la ultima posicion del numero almacendo en la lista
